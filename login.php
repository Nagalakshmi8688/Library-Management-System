...
<main>
        ...
        <div class="background">
            ...
            <div class="box">
                ...
                <label>Name</label><br>
                    <input type="text" class="email" placeholder="Enter your Name" name="username" required><br><br>
    ...
    {
      $count=0;
      $res=mysqli_query($conn,"SELECT * FROM `student` WHERE username='$_POST[username]' && password='$_POST[pass]';");
